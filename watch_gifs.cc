...
int main(int argc, char *argv[])
{
    ...
    int temp_hour = 0;
    int temp_min = 0;
    const char *path_imageviewer = "/home/watch/DigitalLEDWatch/led-image-viewer";
    ...
    while (!interrupt_received)
    {
        ...
        if (tm.tm_hour == 21 && tm.tm_min == 39 && x == 0)
        {
            const char *my_argv[64] = {sudo, path_imageviewer, duration_animation, "/home/watch/source.gif", NULL};
